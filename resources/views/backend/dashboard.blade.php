...
@stop
@section('append_js')
    {{ Html::script(asset('../resources/assets/admin/js/plugins/morris/raphael-min.js'), ['type' => 'text/javascript']) }}
    {{ Html::script(asset('../resources/assets/admin/js/plugins/morris/morris.min.js'), ['type' => 'text/javascript']) }}
    {{ Html::script(asset('../resources/assets/admin/js/plugins/rickshaw/d3.v3.js'), ['type' => 'text/javascript']) }}
    {{ Html::script(asset('../resources/assets/admin/js/plugins/rickshaw/rickshaw.min.js'), ['type' => 'text/javascript']) }}
    {{ Html::script(asset('../resources/assets/admin/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js'), ['type' => 'text/javascript']) }}
    {{ Html::script(asset('../resources/assets/admin/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js'), ['type' => 'text/javascript']) }}
    {{ Html::script(asset('../resources/assets/admin/js/demo_dashboard.js'), ['type' => 'text/javascript']) }}
@stop
