$(document).ready(function(){        
    ...
    $(".mb-destroy-close").on("click",function(){
       $(this).parents(".message-box").modal("toggle");
       return false;
    });
    /* END MESSAGE BOX */
...
function panel_refresh(panel,action,callback){        
    if(!panel.hasClass("panel-refreshing")){
        panel.append('<div class="panel-refresh-layer"><img src="/themes/admin/img/loader.gif"/></div>');
