var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="{{asset(\'../resources/assets/admin/css/theme-default.css\')}}"><img src="{{asset(\'../resources/assets/admin/img/themes/default.jpg\')}}"/></a>'
            +'<a href="#" data-theme="{{asset(\'../resources/assets/admin/css/theme-brown.css\')}}"><img src="{{asset(\'../resources/assets/admin/img/themes/brown.jpg\')}}"/></a>'
            +'<a href="#" data-theme="{{asset(\'../resources/assets/admin/css/theme-blue.css\')}}"><img src="{{asset(\'../resources/assets/admin/img/themes/blue.jpg\')}}"/></a>'
            +'<a href="#" data-theme="{{asset(\'../resources/assets/admin/css/theme-white.css\')}}"><img src="{{asset(\'../resources/assets/admin/img/themes/light.jpg\')}}"/></a>'
            +'<a href="#" data-theme="{{asset(\'../resources/assets/admin/css/theme-black.css\')}}"><img src="{{asset(\'../resources/assets/admin/img/themes/black.jpg\')}}"/></a>'
        +'</div>'
